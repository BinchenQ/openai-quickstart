...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', type=str, required=False, choices=['GLMModel', 'OpenAIModel'], default='OpenAIModel', help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')        
        ...
        self.parser.add_argument('--openai_base_url', type=str, help='The URL for OpenAIModel. Required if model_type is "OpenAIModel".')
        self.parser.add_argument('--book', type=str, nargs='+', help='PDF file to translate. Can be multiple files.')
